let first = null;
let second = "https://discord.gg/MFR";
...
function openLink(value) {
    ...
    if (value == "second") {
        window.location.href = "https://discord.gg/MFR";
    }
    if (value == "third") {
...
function aboutSlide(value) {
    if (value == 1) {
        ...
        document.getElementsByClassName('about-title1')[0].style.borderBottom = "0.2vw solid rgb(0, 255, 234)";
    ...
    if (value == 2) {
        ...
        document.getElementsByClassName('about-title2')[0].style.borderBottom = "0.2vw solid rgb(0, 255, 234)";
        document.getElementsByClassName('about-title3')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title4')[0].style.borderBottom = null;
    }
    if (value == 3) {
        ...
        document.getElementsByClassName('about-title1')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title2')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title3')[0].style.borderBottom = "0.2vw solid rgb(0, 255, 234)";
        document.getElementsByClassName('about-title4')[0].style.borderBottom = null;
    }
    if (value == 4) {
        document.getElementsByClassName('intext')[0].style.transition = "all 1s";
        ...
        document.getElementsByClassName('about-title2')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title3')[0].style.borderBottom = null;
        document.getElementsByClassName('about-title4')[0].style.borderBottom = "0.2vw solid rgb(0, 255, 234)";
    }
}
